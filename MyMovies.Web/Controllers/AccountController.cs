...
namespace MyMovies.Web.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(IUserRoleRepository userRoleRepository,
            IUserRepository userRepository, IUnitOfWork unitOfWork)
            : this(
                new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(new ApplicationDbContext())),
                userRoleRepository, userRepository, unitOfWork)
        {
        }

        public AccountController(UserManager<ApplicationUser> userManager, IUserRoleRepository userRoleRepository, IUserRepository userRepository, IUnitOfWork unitOfWork)
        {
        ...
        //    return System.Web.UI.WebControls.View(users);
        //}
